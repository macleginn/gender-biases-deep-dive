...
PYTHON_SCRIPT="${SCRIPT_DIR}/dissertation_analysing_results.py"

usage() {
  cat <<'EOF'
Usage: run_dissertation_analysing_results_all_he_she_odds.sh [extra python args...]

Runs dissertation_analysing_results.py once for each he_she_odds_results__*.csv
